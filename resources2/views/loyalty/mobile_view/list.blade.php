        ...
        <div class="modal-dialog modal-dialog-centered modal-inner-system" role="document">
            <div class="modal-content">
                <div class="modal-body modal-inner-blog">
                    ...
                    {{ Form::open(['route' => ['mobile_view.loyalties.add', $user_id], 'id' => 'addOrderLoyaltyPoint', 'method' => 'POST']) }}
        ...
        <div class="modal-dialog modal-dialog-centered modal-inner-system" role="document">
            <div class="modal-content">
                <div class="modal-body modal-inner-blog">
                    <h6>Amount Spent</h6>
                    <p>Reward customers every time they make a new Orders.</p>
                    <form id="addAmountLoyalty" method="POST" action="{{route('mobile_view.loyalties.add', $user_id)}}">
                        @csrf
                        <input type="hidden" name="loyaltyId" class="loyalty-id">
        ...
        <div class="modal-dialog modal-dialog-centered modal-inner-system" role="document">
            <div class="modal-content">
                <div class="modal-body modal-inner-blog">
                    <h6>Category Based</h6>
                    <p>Reward customers every time they make a new Orders.</p>
                    <form action="{{ route('mobile_view.loyalties.add', $user_id)}}" method="POST" id="addCategoryLoyalty">
                        @csrf
                        <input type="hidden" name="loyaltyId" class="loyalty-id">
