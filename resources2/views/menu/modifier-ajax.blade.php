                    ...
                    <div class="collapsed a-order" data-toggle="collapse"
                        ...
                        <div class="order-detail">
                            ...
                            <div class="order-icons">
                                <a data-route="{{ route('edit.menu.modifier.post', [$item->modifier_group_id]) }}"
                                    href="javaScript:void(0);" class="openModifierForm action-edit"><i
                                        class="fa fa-pencil" aria-hidden="true"></i></a>
                                <a data-route="{{ route('delete.menu.modifier.post', [$item->modifier_group_id]) }}"
                                    href="javaScript:void(0);" class="delete  action-delete"><i class="fa fa-trash"
                                        aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="order-detail">
                                    ...
                                    <div class="order-icons">
                                        <a data-route="{{ route('edit.modifier.item.post', $item->modifier_item_id) }}"
                                            href="javaScript:void(0);" class="openModifierItemForm action-edit"><i
                                                class="fa fa-pencil" aria-hidden="true"></i></a>
                                        <a data-route="{{ route('delete.menu.modifier.item.post', [$item->modifier_item_id]) }}"
