...
// echo ($request);
    ...
    public function remove_coupon_code(Request $request)
    {
        ...
        Cart::where('cart_id',$request->cart_id)->where('uid',$uid)->where('restaurant_id',$restaurant)->update(['sub_total' => number_format($totalPrice,2),'tax_charge' => number_format($taxCharge,2),'discount_charge' => number_format($dicountcharge,2), 'total_due' => number_format($totalPayableAmount,2),'promotion_id' => 0]);
