     ...
     var AppFeatures = {
         ...
         windowResize: function() {
             ...
             $window.on("load resize", function() {
                 ...
                 $body.removeClass("bematScreenLG bematScreenMD bematScreenSM bematScreenXS bematScreenXXS SidebarOpen").addClass("bematScreen");
     ...
     var AppSidebar = {
         ...
         backdrop: function() {
             ...
             if ($(window).width() < 700) {
                 $('<div id="sidebar-backdrop"></div>').insertBefore("#page-wrapper");
                 $('body').removeClass('sidebar-open').addClass('sidebar-close');
                 $('aside').removeClass('SidebarOpen').addClass('SidebarClose');
                 $('#sidebar-toggle').removeClass('SidebarOpen').addClass('SidebarClose');
                 $('#right-content').removeClass('SidebarOpen').addClass('SidebarClose');
                 $('.sidebar-backdrop').removeClass('sidebar-backdrop')
