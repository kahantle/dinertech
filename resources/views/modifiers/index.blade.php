...
@section('content')
                            ...
                            <div class="order">
                                <div class="collapsed a-order" data-toggle="collapse"
                                    ...
                                    <div class="order-name">
                                        ...
                                        <h4>{{ $item->modifier_group_name }}<a href="javaScript:void(0);"
    ...
    <div id="modifierGroupPopUp" class="modifierGroupPopUp closeAllModal overlay w-100 popup-librate">
        <div class="popup text-center">

            <div class="content">
                <div class="d-flex align-items-center mb-5">
                    <h5 class="groupHeading mb-0 w-100 text-center">Add Modifier Group</h5>
                ...
                <div class="form-group form-check-insides">
                    ...
                    <input type="checkbox" class="styled-checkbox" id="allow_multiple1" name="allow_multiple1" />
                    <label for="allow_multiple1">Required
                ...
                <div class="form-group form-check-insides">
                    ...
                    <label for="allow_multiple2">Single Modifier </label>
                ...
                <div class="form-group form-check-insides">
                    ...
                    <label for="allow_multiple3">Multiple Modifiers </label>
                    <p>Customer may select multiple modifiers</p>
                </div>
                <div class="form-group form-align-blog row align-items-center">

                    <input type="number" class="form-control input-first" id="usr" placeholder="max">


                    <span class="px-3">to</span>


                    <input type="number" class="form-control input-second" id="usr" placeholder="min">
    ...
    <div id="openModifierItemFormPopUp" class="openModifierItemFormPopUp closeAllModal overlay w-100">
        ...
        <div class="popup text-center">
            ...
            <div class="content">
                ...
                {{ Form::open(['route' => ['add.modifier.item.post'],'id' => 'modifierItemForm','method' => 'POST','class' => '']) }}
                <div class="form-group">
                    <input type="text" class="form-control" id="modifier_group_item_name" name="modifier_group_item_name"
                        placeholder="Enter Modifier Item Name">
                </div>
                <div class="form-group">
