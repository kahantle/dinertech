                    ...
                    <div class="promotion-iner-blog mt-3 Promotion-btn-click ">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <img width="35px" src="{{asset('assets/images/divition-icon.png')}}" alt="" />
                                <div class="mx-2">
                                    ...
                                    <div class="item" data-card-id={{ $card->card_id }}>
                                        <div class="wd-dr-background">
                                            <div class="d-flex align-items-center justify-content-between w-100">
                                                ...
                                                @if ($card->card_type ==
                                                Config::get('constants.CARD_TYPE.AMERICAN_EXPRESS'))
                    ...
                    <div class="card p-3 Apply-schar mt-3">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <input type="button" value="Apply" class="aa-browsw-btn" onclick="applyCoupenCode()">
                            </div>
                    ...
                    <div class="card mt-2 a-card-all-css">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <input type="hidden" id="id" value="{{$promotion->promotion_id}}" name="id">
                                    <h5 class="text-uppercase mb-0 promotion_text-cololr">{{$promotion->promotion_code}}
                                    </h5>
                                ...
                                <div>
                                    ...
                                    <input type="button" value="Apply" class="aa-browse-btn" onclick="applyPromotion()">
                                </div>
                            </div>
                        </div>
