...
.bgcolorchange{
    ...
    box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.15); /* Uniform shadow on all sides */
    padding: 10px; /* Adds spacing inside */
    border-radius: 20px 0 20px 0 !important; /* Optional: Soft rounded corners */
}
/* .wd-dr-dashboart-inner {
    margin-left: auto;
    margin-right: auto;
    display: block;
} */
            ...
            <div class="card order-content">
                <div class="card-body p-2">
                        ...
                        @auth
                                        ...
                                        <div
                                            ...
                                            <div class="wb-inner-system-first">
                                                <div class="d-flex wd-menu-photo justify-content-between w-100">
                                                    <div class="no-photos-blog">
                                                        ...
                                                        @if($item->is_loyalty==1) 
                                                            <div class="iconbutton d-flex align-items-center text-danger">
                                                                <p class="mb-0" style="color: red; font-size: small; font-weight: 200;"><i class="fa fa-gift" aria-hidden="true"></i> {{ $item->loyalty_point }} pts</p>
                                                            </div>
                                                        @endif
                                                ...
                                                @if( $user && $isRedeemable && !$loyaltyCount && (int)$loyaltyPoint < (int)$user->total_points)
                                                    ...
                                                    <a href="#" class="iconbutton d-flex align-items-start justify-content-center col-9 mt-3 redeemProduct"
                                                        data-cartLoyaltyRuleId="{{$isRedeemable->loyalty_rule_id}}" 
                                                        data-cartMenuId="{{$item->menu_id}}">
                                                        <p> <i class="fa fa-gift" aria-hidden="true"></i>Redeem for {{ $loyaltyPoint }} pts</p>
                            ...
                            <div class="promotion-iner-blog mt-3 Promotion-btn-click  bgcolorchange1">
                            ...
                            <div class="promotion-iner-blog-close bgcolorchange">
                                <div class="d-flex align-items-center selected-promotion">
                                    <div class="mx-2">
                            ...
                            <div class="text-center" id="tips">
                                ...
                                @php
                                    $totalwithsalestax = ($cart['sub_total'] ?? 0.00) + ($cart['tax_charge'] ?? 0.00);
                                @endphp
                                <div class="tips input-group mb-0 full-div ">
                                    <div class="input-group-prepend flex-row w-100 d-flex  flex-wrap">
                                        <div class="tip-item d-flex flex-column align-items-center ">
                                            <span class="stafftip" >Tip 1</span>
                                            <button type="button" value="{{ round($totalwithsalestax * $tip1) / 100 ,2 }}" class="btn btn-light tip tipbutton ">${{round($totalwithsalestax * $tip1) / 100 ,2}}</button>
                                        </div>
                                        <div class="tip-item d-flex flex-column align-items-center">
                                            <span class="stafftip">Tip 2</span>
                                            <button type="button" value="{{round($totalwithsalestax * $tip2) / 100 ,2}}" class="btn btn-light tip tipbutton">${{ round($totalwithsalestax * $tip2) / 100 ,2 }}</button>
                                        </div>
                                        <div class="tip-item d-flex flex-column align-items-center">
                                            <span class="stafftip">Tip 3</span>
                                            <button type="button" value="{{ round($totalwithsalestax * $tip3) / 100 ,2 }}" class="btn btn-light tip tipbutton">${{ round($totalwithsalestax * $tip3) / 100 ,2 }}</button>
                                        </div>
                                        ...
                                        <div class="tip-item no d-flex flex-column align-items-center selected">
                                            <button type="button" value="0" class="btn btn-light tip tipbutton-no">No Tip</button>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="pagination-container mt-3">
                                                        ...
                                                        <div class="pagination">
                                                            @foreach ($cards as $key=>$card)
                                                                <span class="page {{ $key==0 ? 'active' : '' }}" data-index="{{ $key }}"></span>
                                                            @endforeach
                                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        // Handle Clicking Page Indicators
