...
<section id="wrapper">
  ...
  {{ Form::open(array('route' => array('verify.menu.pin'),'id'=>'verify_pin','method'=>'POST','class'=>'')) }}
       ...
       <div class="form-info pt-lg-5 pt-4">
          <div class="text text-center">
            <div class="code form_pin">
                ...
                <input type="hidden" id="redirect_route" value="{{ $redirect_url }}">
              <ul>
...
<script>
    ...
    var returnRoute = $('#redirect_route').val();
    var verify_pin_route = "{{route('verify.menu.pin')}}";
    var account_route = returnRoute;
</script>
@endsection
