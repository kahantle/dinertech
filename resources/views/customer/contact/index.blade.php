                ...
                <div class="col-md-6 map-contact">
                    <div class="media">
                        <div class="media-left">
                            <a href="#" alt="Map">
                                <img class="media-object" src="{{ asset('assets/customer/images/map-black.png') }}"
                                    alt="...">
                            </a>
                        </div>
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#" alt="Mail">
                                <img class="media-object" src="{{ asset('assets/customer/images/mail.png') }}"
                                    alt="...">
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#" alt="Phone">
                                <img class="media-object" src="{{ asset('assets/customer/images/phone.png') }}"
                                    alt="...">
                            </a>
                        </div>
                        <div class="media-body">
