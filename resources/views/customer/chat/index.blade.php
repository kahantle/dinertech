                                                    ...
                                                    <div class="message-input">
                                                        <div class="wrap">
                                                            <input type="text" value=""
                                                                ...
                                                                id="message-output">
                                                            <button class="submit  sendMessage"
                                                                data-orderid="{{ $orderId['order_id'] }}"
                                                                alt="Submit"><i class="fa fa-paper-plane"
                                                                    aria-hidden="true"></i></button>
                                                            <button class="submit micro start" alt="Micro"
                                                                data-orderid="{{ $orderId['order_id'] }}"
                                                                id="start{{ $orderId['order_id'] }}"><i
...
<script>
    ...
    var customerImage = '{{ route('display.image', [Config::get('constants.IMAGES.USER_IMAGE_PATH'), Auth::user()->profile_image]) }}';
    if (!customerImage) {
