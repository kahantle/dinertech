...
@section('content')
    <section id="wrapper">
        ...
        <div class="add-category Promotion menu dashboard content-wrapper category category-insides-blog">
            ...
            <div class="container-fluid">
                {{ Form::open(['route' => ['update.menu.post'],'id' => 'menuForm','method' => 'POST','class' => 'form','files' => 'true']) }}
                <input type="hidden" name="hidden_id" value="{{ $menuItem->menu_id }}">

                <span class="slt-img">
                    @if ($menuItem->item_img)
                        {{-- <img src="{{ route('display.image', [config('constants.IMAGES.MENU_IMAGE_PATH'), $menuItem->item_img]) }}"
                            class="img-fluid"> --}}
                    @endif
                </span>
                ...
                <div class="row">
                    {{-- <div class="col-lg-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="item_name" placeholder="Enter Menu Item"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="item_details"
                                placeholder="Enter Menu Details">{{ $menuItem->item_details }}</textarea>
                        </div>
                        <div class="form-group select-input">
                            ...
                            <select type="text" class="form-control" name="category_id" placeholder="Enter Item Catagory">
                                <option value="{{ $menuItem->category_id }}" selected>{{ $menuItem->category_name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="item_price" placeholder="Enter Item Price"
                                value="{{ $menuItem->item_price }}"></input>
                        </div>
                        <div class="form-group select-input">
                            <img style="    z-index: 1;" src="{{ asset('assets/images/category-detail.png') }}">

                            <select type="text" class="form-control select2" name="modifier_group_id[]" multiple
                                id="modifier_id" placeholder="Select Modifiers">
                                @foreach ($modifiers as $modifier)
                                    <option value="{{ $modifier->modifier_group_id }}" @php
                                        $modifers = $menuItem->modifiers->pluck('modifier_id')->toArray();
                                    @endphp @if (in_array($modifier->modifier_group_id, $modifers))
                                        selected='selected'
                    ...
                    <div class="col-lg-7">
                        <div class="grey-line">
                            ...
                            <div class="plus">
                                <a href="javaScript:void(0);" class="openModifierForm"><i class="fa fa-plus"
