...
<section id="wrapper">
  ...
  <div class="add-category Promotion dashboard content-wrapper category">
    ...
    <div class="container-fluid p-0">
      {{ Form::open(array('route' => array('add.menu.post'),'id'=>'menuForm','method'=>'POST','class'=>'','files'=>'true',
    )) }}
      <div class="row">
        <div class="col-lg-5">
          ...
          <div class="form-group">   
            ...
            <input type="text" class="form-control" name="item_name" value="{{old('item_name')}}" placeholder="Enter Menu Item">
          </div>
          <div class="form-group">   
          ...
          <div class="form-group select-input">   
            ...
            <select type="text" class="select2 form-control " name="modifier_group_id[]" id="modifier_id" multiple="multiple" placeholder="Enter Modifiers">
