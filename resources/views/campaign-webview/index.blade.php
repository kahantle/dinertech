...
@section('content')
    <section>
        <div class="mobile-add-campaign">
            <a href="{{ route('restaurant.email.campaign.create', $uid) }}" target="_blank" class="add-campaign-blog">
                ...
                <div class="wd-dr-current-plan">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Subscribers:<span>&nbsp;{{ $restaurant_subscribers }}/{{ $totalSubscribers[1] }}</span></p>
                            <p>Billing
                        ...
                        <div class="card-footer">
                            <a class="upgrade-plan-bog mr-4"
                                href="{{ route('restaurant.email.subscription.cancel', [$stripeSubscription->id, $uid]) }}">Cancel
                                Plan</a>
                            <a class="upgrade-plan-bog"
                                href="{{ route('restaurant.email.subscription.upgrade', $uid) }}">Upgrade Plan</a>
                        </div>
                    </div>
                </div>
...
@section('scripts')
    <script src="{{ asset('/assets/js/campaign/index-webview.js') }}"></script>
@endsection
