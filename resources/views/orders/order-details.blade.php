...
@section('content')
                                ...
                                <div>
                                    <div class="messenger">
                                        <a href="{{ route('chat', ['order_id' => $order->order_number]) }}"><img
                                                src="{{ asset('assets/images/messenger.png') }}"
                                                class="img-fluid"></a>
                                    </div>
                                    <div class="type">
                                        <a href="javaScript:void(0);"
                                            onclick="printJS('{{ route('order.pdf', $order->order_id) }}')"><img
                                                src="{{ asset('assets/images/type-v.png') }}" class="img-fluid"></a>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="order-content">
                            @if ($order->order_progress_status == 'CANCEL')
                                <div class="o-name  red ">
                                    ...
                                    <p>Date & Time : {{ date('m/d/Y', strtotime($order->created_at)) }}
                            ...
                            <div class="o-address">
                                <h5>Address</h5>
                                @if ($orderAddress)
                                    <p>{{ $orderAddress->address }}<br />{{ $orderAddress->state }},{{ $orderAddress->city }},{{ $orderAddress->zip }}
                                    </p>
                                @else
                                    <p>-</p>
                                @endif
                                        ...
                                        @foreach ($items->orderModifierItems as $modifier)
                                            <ul>
                                                <li>
                                                    ...
                                                    <p>${{ number_format((float) $items->modifier_total, 2, '.', '') }}
                                                    </p>
                                                </li>
                                            </ul>
                                        @endforeach
                                ...
                                <div class="three-btn">
                                    <div class="btn-custom">
                                        <a class="btn-orange action" href="javaScript:void(0);"
                                            ...
                                            data-value="Prepare"><span>prepared order</span></a>
                                    </div>
                                </div>
                        </div>
                        ...
                        <div class="three-btn">
                            <div class="btn-custom">
                                <a class="btn-orange action" data-toggle="tooltip" title="Pick-up order"
                                    ...
                                    class="grey-border action" data-value="pickup"><span>Pick up</span></a>
                            </div>
                        </div>
                        @endif
                    </div>
    ...
    <div id="openTimePicker" class="openTimePickerPopUp closeAllModal overlay w-100 minitues-modal">
