                  ...
                  <div class="orders no-long-list">
                    ...
                    <div class="order">
                      ...
                      <div class="order-detail">
                        ...
                        <div class="order-icons order-blog-inner">
                          <a href="javaScript:void(0);" onclick="printJS('{{route('order.pdf',$order->order_id)}}')"
                            data-toggle="tooltip" title="Print Order Receipt!" class=""><img
                              src="{{ asset('images/type.png') }}" class="img-fluid icon"></a>
                        </div>
                        <div class="detail">
