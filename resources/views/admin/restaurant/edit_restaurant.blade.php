                ...
                <section class="page-content res-edit-page-content">
                    ...
                    <div class="row zmd-hierarchical-display in" data-animation="hierarchical-display">
                        <div class="col-sm-6 zoomIn animated right-border" style="animation-delay: 0.12s;">
                            ...
                            {{ Form::open(array('route' => array('admin.restaurants.update'),'id'=>'restaurantForm','method'=>'POST','class'=>'res-edit-form','files'=>'true')) }}
                            {{-- <form class="res-edit-form" method="POST" action="{{route('admin.restaurants.update')}}"> --}}
                                {{-- @csrf --}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="restaurant_address" placeholder="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry."></textarea>
                                    
                                    <input type="text" class="form-control" name="mobile_number"  placeholder="Mobile Number" value="{{$restaurant->mobile_number}}" >
                                    
                                    {{-- <input type="text" class="form-control"  placeholder="+01-555 556 5555"> --}}
                                    <input type="text" class="form-control" name="email"  placeholder="Email" value="{{$restaurant->email_id}}" >
                                    {{-- <input type="text" class="form-control"  placeholder="www.Jeorge_Almiston.com"> --}}
                                </div>
                                <div class="form-group">
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\PromotionRequest','#restaurantForm'); !!}
