                        ...
                        <div class="wd-dr-page-dropdown">
                            <div class="page-header_title wd-dr-page-title">
                                ...
                                <div class="drop-down w-dirst-drop">
                                    <div class="selected">
                                        <a href="#" class="wd-dr-sec"><span>Custom<span class="value"></span></span><div class="caret"></div></a>
                                    </div>
                                    <div class="options">
                            ...
                            <div class="wd-dr-dropdown">
                                ...
                                <div class="drop-down">
                                    <div class="selected">
                                        <a href="#" class="wd-dr-sec"><span></span><div class="caret"></div></a>
                                    </div>
                                    <div class="options">
                                        <ul style="display: none;">
                                            <li class="filter" data-filter="Month"><a href="#">Month<span class="value"></span></a></li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="stat-wrapper margin-vertical-4">
                                                                ...
                                                                <div class="linear-progress-demo  cc-preloader-primary" data-toggle="linear-progress" data-mode="indeterminate" data-type="primary" data-value="57" style="width: 100%;">
                                                                    <div class="md-progress-linear" role="progressbar" md-mode="" aria-valuemax="100" aria-valuemin="0" aria-valuenow="88" value="88">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="stat-wrapper">
                                                                <h4 class="no-margin-top margin-bottom-2">Live Messages <span class="pull-right">781</span></h4>
                                                                <div class="linear-progress-demo  cc-preloader-primary" data-toggle="linear-progress" data-mode="determinate" data-type="primary" data-value="75" style="width: 100%;" aria-valuenow="75" value="75">
                                                                    <div class="md-progress-linear" role="progressbar" md-mode="" aria-valuemax="100" aria-valuemin="0" aria-valuenow="88" value="88">
                                                                        <div class="md-container md-mode-determinate">
                                                                            <div class="md-dashed"></div>
                                                                            <div class="md-bar md-bar1"></div>
                                                                            <div class="md-bar md-bar2" style="transform: translateX(-12.5%) scale(0.75, 1);"></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-6">
                                <div class="panel panel-default" data-animation="animate" data-animation-in="zoomIn">
                                    <div class="panel-heading">
                                        <header>Live Sales
                                            <span class="panel-date">21/2/2021</span>
                                        </header>
                                ...
                                <div class="panel panel-default" data-animation="animate" data-animation-in="zoomIn">
                                    <div class="panel-heading">
                                        <header>Active Orders
                                            <span class="panel-date">24/2/2021</span>
                                        </header>
