                    ...
                    <div class="col-lg-4 p-0">
                        <div class="chat-table">
                            <div class="chat-search">
                                ...
                                <input type="search" id="chat-search" class="searchText" value="{{ $orderNumber }}"
                                    placeholder="Search here">
                            </div>
                            @foreach ($orders as $key => $item)
                                @if (!empty($last_messages[$key]))
                                    <div class="chat-content @if ($key == 0) active @endif"
                                        data-customer_id="{{ $item->user->uid }}"
                                        data-user_name="{{ $item->user->full_name }}"
                                        data-order_id="{{ $item->order_number }}" data-id="{{ $item->order_id }}">
                                        ...
                                        <div class="chat-name">
                                            ...
                                            <div class="cn-right">
                                                ...
                                                <i
                                                    class="{{ $last_messages[$key]['is_seen'] ? 'fa fa-circle text-danger display-1' : '' }}"></i>
                                                <span></span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-8 p-0">
                        <div class="chat-details ">
                            ...
                            <div class="chat-header ">
                                ...
                                <div class="ch-right">
                                    <a href="#0"><img src="{{ asset('assets/images/bell.png') }}"
                                            class="img-fluid"></a>
                                    <a href="#0"><img src="{{ asset('assets/images/exit.png') }}"
                                            class="img-fluid"></a>
                                </div>
                            </div>
                            ...
                            <div class="chat-footer">
                                ...
                                <div class="cf-icon">
                                    ...
                                    <a href="#0"><img src="{{ asset('assets/images/send.png') }}"
                                            class="send-icon sendToken sendMessage"></a>
                                    <a href="#0"><img src="{{ asset('assets/images/microphone.png') }}"
                                            class="microphone-icon "></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $('document').ready(function() {
            ...
            function wordFilter(str) {
                // var filterWords = ["fool", "dumb", "shit", "ass", "couch potato","fuck"];
                var filterWords = ["4r5e", "5h1t", "5hit", "a55", "anal", "anus", "ar5e", "arrse", "arse", "ass",
                    ...
                    "d1ck", "damn", "dick", "dickhead", "dildo", "dildos", "dink", "dinks", "dirsa", "dlck",
                    "dog-fucker", "doggin", "dogging", "donkeyribber", "doosh", "duche", "dyke", "ejaculate",
                    "ejaculated", "ejaculates", "ejaculating", "ejaculatings", "ejaculation", "ejakulate",
                    "f u c k", "f u c k e r", "f4nny", "fag", "fagging", "faggitt", "faggot", "faggs", "fagot",
                    "fagots", "fags", "fanny", "fannyflaps", "fannyfucker", "fanyy", "fatass", "fcuk", "fcuker",
                    ...
                    "goddamned", "hardcoresex", "heshe", "hoar", "hoare", "hoer", "homo", "hore", "horniest",
                    "horny", "hotsex", "jack-off", "jackoff", "jap", "jerk-off", "jism", "jiz", "jizm", "jizz",
                    "kawk", "knob", "knobead", "knobed", "knobend", "knobhead", "knobjocky", "knobjokey",
                    "kock", "kondum", "kondums", "kum", "kummer", "kumming", "kums", "kunilingus", "l3i+ch",
                    ...
                    "nob jokey", "nobhead", "nobjocky", "nobjokey", "numbnuts", "nutsack", "orgasim",
                    "orgasims", "orgasm", "orgasms", "p0rn", "pawn", "pecker", "penis", "penisfucker",
                    "phonesex", "phuck", "phuk", "phuked", "phuking", "phukked", "phukking", "phuks", "phuq",
                    "pigfucker", "pimpis", "piss", "pissed", "pisser", "pissers", "pisses", "pissflaps",
                    "pissin", "pissing", "pissoff", "poop", "porn", "porno", "pornography", "pornos", "prick",
                    "pricks", "pron", "pube", "pusse", "pussi", "pussies", "pussy", "pussys", "rectum",
                    ...
                    "titties", "tittyfuck", "tittywank", "titwank", "tosser", "turd", "tw4t", "twat",
                    "twathead", "twatty", "twunt", "twunter", "v14gra", "v1gra", "vagina", "viagra", "vulva",
                    "w00se", "wang", "wank", "wanker", "wanky", "whoar", "whore", "willies", "willy", "xrated",
                    "xxx"
                ];
                ...
                firebase.database().ref(url).on('value', function(snapshot) {
                    ...
                    $.each(value, function(index, value) {
                        if (value.sent_from == 'RESTAURANT') {
                            ...
                            chat_element += '     <div class="cht-msg">'
                            chat_element += '       <p>' + value.message + '</p>';
                            chat_element += '        <span>' + value.message_date +
                                '</span>';
                            chat_element += '      </div>'
                            chat_element += '    </li>'
                        } else {
                        ...
                        var update_url = '/' + db_name + '/' + resturant_id + '/' +
                            order_id + '/' +
                            customer_id + '/' + index;
                        // // value.is_read = 1;
                        // value.isseen = true;
                        ...
                        var updates = {};
                        updates[update_url] = value;
                        firebase.database().ref(update_url).update({
                            isseen: true
                        });
                        $(".msg-body").html(chat_element);
                        $("#message").val('');
