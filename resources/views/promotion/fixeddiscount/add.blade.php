...
@section('content')
    @if ($webview == 1)
        {{ Form::open(array('route' => array('promotion.add.fixed-discount.webView'),'id'=>'promotionForm','method'=>'POST','class'=>'')) }}
        <input type="hidden" name="restaurant_user_id" value="{{$uid}}">
    @else
        {{ Form::open(array('route' => array('promotion.add.free.fixeddiscount.post'),'id'=>'promotionForm','method'=>'POST','class'=>'')) }}
    @endif
                    ...
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <div class="profile-title-new">
                                ...
                                <h2> Add Fixed Discount Amount On A Combo Deal</h2>
                            </div>
                        </div>
                    </div>
                </nav>
                ...
                <div class="row">
                    ...
                    <div class="@if($webview == 1) col-md-7 @else col-lg-7 @endif promotion-add-border">
                        ...
                        <div class="form-group minimumAmountDiv">
							...
							<input type="text" class="form-control" id="minimumAmount" name="discount_usd_percentage_amount" placeholder="Discount (USD)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                        </div>
