                    ...
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <div class="profile-title-new">
                                ...
                                <h2> Edit Fixed Discount Amount On A Combo Deal</h2>
                            </div>
                        </div>
                    </div>
                </nav>
                ...
                <div class="row">
                    ...
                    <div class="@if($webview == 1) col-md-7 @else col-lg-7 @endif promotion-add-border">
                        ...
                        <div class="form-group minimumAmountDiv">
							...
							<input type="text" class="form-control" id="minimumAmount" name="discount_usd_percentage_amount" placeholder="Discount (USD)" value="{{$promotion->discount}}">
                        </div>
