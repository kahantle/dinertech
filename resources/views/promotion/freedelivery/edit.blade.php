                ...
                <div class="row">
                    ...
                    <div class="@if($webview == 1) col-md-7 @else col-lg-7 @endif promotion-add-border">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control discount_percentage" id="discount_amount" name="discount_usd_percentage_amount" placeholder="Discount in %" value="{{$promotion->discount}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                        </div>
                        ...
                        @endif
                            <img src="{{ asset('assets/images/tag-d.png') }}">
                            <input type="text" class="form-control" id="minimumAmount" name="set_minimum_order_amount" placeholder="Minimum Order Amount" value="{{$promotion->set_minimum_order_amount?$promotion->set_minimum_order_amount:''}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                        </div>
