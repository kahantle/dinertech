            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="promotion_code" name="promotion_code"
                            placeholder="Promo code(Optional)" value="{{$promotion->promotion_code}}" maxlength="15">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="promotion_details" name="promotion_details"
                            placeholder="Enter Description(Optional)">{{$promotion->promotion_details?$promotion->promotion_details:''}}</textarea>
                    </div>
                </div>
                <div class="col-md-7 promotion-add-border">
                    ...
                    <div class="form-group mb-0 d-flex flex-column">
                        <input type="radio" id="usd" name="discount_usd_percentage" value="USD"
                            class="discountUsdPercentage" {{($promotion->discount_type =='USD')?'checked':''}}>
                        <label for="usd">Discount in $</label>
                        <input type="radio" id="percentage" name="discount_usd_percentage" value="PERCENT"
                            class="discountUsdPercentage" {{($promotion->discount_type =='PERCENT')?'checked':''}}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="discount_amount"
                            name="discount_usd_percentage_amount" placeholder="Discount (USD)"
                            value="{{$promotion->discount?$promotion->discount:''}}"
                    ...
                    <div class="form-group cs-checkbox">
                        <input type="checkbox" class="checkbox-custom setMinimumOrderAmount" value="allow"
                            id="setMinimumOrderAmount" name="set_minimum_order"
                    ...
                    <div class="form-group select-input">
                        ...
                        <select name="client_type" id="client_type" class="form-control">
                            ...
                            <option value="{{$item}}" {{($promotion->client_type==$item)?'selected':''}}>{{$item}}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group select-input">
                        ...
                        <select name="order_type" id="order_type" class="form-control">
                            ...
                            <option value="{{$item}}" {{($promotion->order_type==$item)?'selected':''}}>{{$item}}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group cs-checkbox mb-2">
                        <input type="checkbox" class="checkbox-custom onlyForSelectedPayment" id="payment"
                            ...
                            {{($promotion->only_selected_payment_method)?'checked':''}}>
                        ...
                        <div class="form-group cs-checkbox onlyForSelectedPaymentDiv">
                            ...
                            <div class="form-group cs-checkbox onlyForSelectedPaymentDiv" style="display: none">
                                ...
                                <div class="cash-blog mt-1">
                                    <input type="checkbox" class="checkbox-custom cash" id="cash"
                                        name="only_selected_cash" {{($promotion->only_selected_cash)?'checked':''}}>
                                    <label for="cash">Cash</label>
                                </div>
                                <div class="cash-blog">
                                    <input type="checkbox" class="checkbox-custom cardtodelivery" id="cardtodelivery"
                                        name="only_selected_cash_delivery_person"
                                        {{($promotion->only_selected_cash_delivery_person)?'checked':''}}>
                        ...
                        <div class="form-group cs-checkbox mb-2">
                            <input type="checkbox" class="checkbox-custom" id="client" name="only_once_per_client"
                                {{($promotion->only_once_per_client == "true")?'checked':''}}>
                        ...
                        <div class="form-group select-input">
                            ...
                            <select name="no_extra_charge" id="no_extra_charge" class="form-control">
                                ...
                                <option value="{{$item}}" {{($promotion->no_extra_charge_type==$item)?'selected':''}}>
                                    {{$item}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group select-input">
                            ...
                            <select name="promotion_function" id="promotion_function" class="form-control">
                                ...
                                <option value="{{$item}}" {{($promotion->promotion_function==$item)?'selected':''}}>
                                    {{$item}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group select-input">
                            ...
                            <select name="availability" id="availability" class="form-control">
                                ...
                                <option value="{{$item}}" {{($promotion->availability==$item)?'selected':''}}>{{$item}}
                                </option>
                                @endforeach
                            </select>
                        </div>
