...
@section('content')
@if ($webview == 1)
{{ Form::open(array('route' => array('promotion.add.buy-twoThree-get-one.webView'),'id'=>'promotionForm','method'=>'POST','class'=>'')) }}
<input type="hidden" name="restaurant_user_id" value="{{$uid}}">
@else
{{ Form::open(array('route' => array('promotion.add.free.buytwothree.post'),'id'=>'promotionForm','method'=>'POST','class'=>'')) }}
@endif
...
<section id="wrapper">
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <div class="profile-title-new">
                        ...
                        <h2>Add Buy 2,3..get one free.</h2>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <div class="add-category Promotion content-wrapper">
            ...
            <div class="row">
                <div class="@if($webview == 1) col-md-5 @else col-lg-5 @endif">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="promotion_code" name="promotion_code"
                            placeholder="Promo code(Optional)" maxlength="15">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="promotion_details" name="promotion_details"
                ...
                <div class="@if($webview == 1) col-md-7 @else col-lg-7 @endif promotion-add-border">
                            ...
                            <div class="input-popup inputpop-inner w-100" id="eligibleItems">
                                <div id="eligible-item-one" class="eligible-item form-group">
                                    <a href="#field-one" class="fill-inner w-100 fill-sec">
                                        <img src="{{ asset('assets/images/order-cart.png')}}"
                                            class="items-inner-st-sec wd-dr-wrapper">
                                        <p name="slct-two" id="slct-one" class="form-control inner-p-wrapper-blog-sys">
                                            Eligible Items Group 1</p>
                                    </a>
                                    <button type="button" class="btn btn-remove btn-remove-one"
                                        data-remove="one">✕</button>

                                    <div>
                                        <input type="text"
                                            style="clip-path: circle(0);height: 0;padding: 0; width: 0; position: absolute; opacity: 0;"
                                            id="hidden_eligible_item_one" name="hidden_eligible_item_one" />
                                    </div>
                                </div>
                                ...
                                <div id="eligible-item-two" class="eligible-item form-group">
                                    <a href="#field-two" class="fill-inner w-100 fill-sec">
                                        <img src="{{ asset('assets/images/order-cart.png')}}"
                                            class="items-inner-st-sec wd-dr-wrapper">
                                        <p name="slct-two" id="slct-two" class="form-control inner-p-wrapper-blog-sys">
                                            Eligible Items Group 2</p>
                                    </a>
                                    <button type="button" class="btn btn-remove btn-remove-two"
                                        data-remove="two">✕</button>

                                    <div>
                                        <input type="text"
                                            style="clip-path: circle(0);height: 0;padding: 0; width: 0; position: absolute; opacity: 0;"
                                            id="hidden_eligible_item_two" name="hidden_eligible_item_two" />
                                    </div>
                                </div>
                                ...
                                <div id="eligible-item-three" class="eligible-item form-group">
                                    <a href="#field-three" class="fill-inner w-100 fill-sec">
                                        <img src="{{ asset('assets/images/order-cart.png')}}"
                                            class="items-inner-st-sec wd-dr-wrapper">
                                        <p name="slct-three" id="slct-three"
                                            class="form-control inner-p-wrapper-blog-sys">Eligible Items Group 3</p>
                                    </a>
                                    <button type="button" class="btn btn-remove btn-remove-three"
                                        data-remove="three">✕</button>

                                    <div>
                                        <input type="text"
                                            style="clip-path: circle(0);height: 0;padding: 0; width: 0; position: absolute; opacity: 0;"
                                            id="hidden_eligible_item_three" name="hidden_eligible_item_three" />
                                    </div>
                                </div>
                    ...
                    <div class="tab-container">
                        <div class="tab-navigation" id="select-discount-type">
                        ...
                        <div id="tab-2" class="tab-content" style="display: none">
                            <div id="addItemGroup">
                                <div class="input-group mb-3 manually-discount manually-discount-one">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text inner-text-blog">
                                            Items Group 1:
                                        </span>
                                    </div>
                                    <input type="text" class="form-control discount_percentage" value="100"
                                        name="item_group_discount[1]"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text input-group-text-first">%</span>
                                    </div>
                                </div>
                                <div class="input-group mb-3 manually-discount manually-discount-two">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text inner-text-blog">
                                            Items Group 2:
                                        </span>
                                    </div>
                                    <input type="text" class="form-control discount_percentage" value="0"
                                        name="item_group_discount[2]"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text input-group-text-first">%</span>
                                    </div>
                                </div>
                                <div class="input-group mb-3 manually-discount manually-discount-three">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text inner-text-blog">
                                            Items Group 3:
                                        </span>
                        ...
                        <div id="tab-1" class="tab-content">
                            ...
                            <div id="addDiscountItem">
                                <div class="input-group mb-3 automatically-discount automatically-discount-two">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text inner-text-blog pr-5"></span>
                                    </div>
                                    <input type="text" class="form-control discount_percentage" value="0"
                                        name="item_discount[2]"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                        readonly>
                                    <div class="input-group-prepend">
                                        <span class="input-group-text input-group-text-first">%</span>
                    ...
                    <div class="form-group cs-checkbox">
                        <input type="checkbox" class="checkbox-custom onlyForSelectedPayment" id="payment"
                            name="only_selected_payment_method">
                        ...
                        <div class="form-group cs-checkbox onlyForSelectedPaymentDiv" style="display: none">
                            ...
                            <div class="cash-blog">
                                <input type="checkbox" class="checkbox-custom cardtodelivery" id="cardtodelivery"
                                    name="only_selected_cash_delivery_person">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    <div class="accordion row" id="accordion">
                                        <div class="form-group col-md-6">
                                            <label for="daysInput">Date</label>
                                            <input data-provide="datepicker" value="" data-date-autoclose="true"
                                                class="form-control" placeholder="Select Date"
                                                data-date-format="mm-dd-yyyy" name="restricted_days" id="daysInput">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="hoursInput">Hours</label>
                            ...
                            <div class="popup text-center">
                                ...
                                <div class="content">
                                    <div id="accordion" class="accordion">
                                        ...
                                        <div class="card mb-0">
                                            <div class="form-group cs-checkbox">
                                                <input type="checkbox" class="checkbox-custom categoryList"
                                                    id="category_one{{$key}}" value="{{$value->category_id}}"
                                                    name="category[1][{{$value->category_id}}]" data-category="one">
                                                <label for="category_one{{$key}}">{{$value->category_name}}</label>
                                            </div>
                                            <div class="card-header collapsed" data-toggle="collapse"
                                                href="#collapse_one{{$key}}">
                                                <a class="card-title">
                                                    <i class="fa fa-plus"></i>
                                                </a>
                                            </div>
                                            <div id="collapse_one{{$key}}" class="card-body collapse"
                                                data-parent="#accordion">
                                                @foreach($value->category_item as $key1=>$value1)
                                                <div class="form-group cs-checkbox">
                                                    <input type="checkbox"
                                                        class="checkbox-custom category_item_one category_one{{$key}}"
                                                        id="item{{$value->category_id}}{{$key1}}1"
                                                        value="{{$value1->menu_id}}"
                                                        name="category[1][{{$value->category_id}}][{{$value1->menu_id}}]"
                                                        data-category="one">
                                                    <label
                                                        for="item{{$value->category_id}}{{$key1}}1">{{$value1->item_name}}</label>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="form-group form-btn justify-content-center">
                                    <a class="close eligible_popup_remove eligible_popup-inner" href="#"
                                        data-popup="one">Submit</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="content">
                                    <div id="accordion" class="accordion">
                                        ...
                                        <div class="card mb-0">
                                            <div class="form-group cs-checkbox">
                                                <input type="checkbox" class="checkbox-custom categoryList"
                                                    id="category_two{{$key}}" value="{{$value->category_id}}"
                                                    name="category[2][{{$value->category_id}}]" data-category="two">
                                                <label for="category_two{{$key}}">{{$value->category_name}}</label>
                                            </div>
                                            <div class="card-header collapsed" data-toggle="collapse"
                                                href="#collapse_two{{$key}}">
                                                <a class="card-title">
                                                    <i class="fa fa-plus"></i>
                                                </a>
                                            </div>
                                            <div id="collapse_two{{$key}}" class="card-body collapse"
                                                data-parent="#accordion">
                                                @foreach($value->category_item as $key1=>$value1)
                                                <div class="form-group cs-checkbox">
                                                    <input type="checkbox"
                                                        class="checkbox-custom category_item_two category_two{{$key}}"
                                                        id="item{{$value->category_id}}{{$key1}}2"
                                                        value="{{$value1->menu_id}}"
                                                        name="category[2][{{$value->category_id}}][{{$value1->menu_id}}]">
                                                    <label
                                                        for="item{{$value->category_id}}{{$key1}}2">{{$value1->item_name}}</label>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="content">
                                    <div id="accordion" class="accordion">
                                        ...
                                        <div class="card mb-0">
                                            <div class="form-group cs-checkbox">
                                                <input type="checkbox" class="checkbox-custom categoryList"
                                                    id="category_three{{$key}}" value="{{$value->category_id}}"
                                                    name="category[3][{{$value->category_id}}]">
                                                <label for="category_three{{$key}}">{{$value->category_name}}</label>
                                            </div>
                                            <div class="card-header collapsed" data-toggle="collapse"
                                                href="#collapse_three{{$key}}">
                                                <a class="card-title">
                                                    <i class="fa fa-plus"></i>
                                                </a>
                                            </div>
                                            <div id="collapse_three{{$key}}" class="card-body collapse"
                                                data-parent="#accordion">
                                                @foreach($value->category_item as $key1=>$value1)
                                                <div class="form-group cs-checkbox">
                                                    <input type="checkbox"
                                                        class="checkbox-custom category_item_three category_three{{$key}}"
                                                        id="item{{$value->category_id}}{{$key1}}3"
                                                        value="{{$value1->menu_id}}"
                                                        name="category[3][{{$value->category_id}}][{{$value1->menu_id}}]"
                                                        data-category="three">
                                                    <label
                                                        for="item{{$value->category_id}}{{$key1}}3">{{$value1->item_name}}</label>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
        ...
        <div class="form-group form-btn-menu from-inner">
            <div class="btn-custom">
                <button type="button" class="btn-grey btn-inner cancel"><span><a style="color:black"
                            href="/close">Cancel</a></span></button>
            </div>
            <div class="btn-custom">
